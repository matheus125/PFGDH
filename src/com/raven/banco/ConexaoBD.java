...
public class ConexaoBD {
    ...
    private static final String URL = "jdbc:mysql://localhost/jesus_me_deu";       // Exemplo: "jdbc:mysql://localhost/dev05"
    ...
    private final String url = "jdbc:mysql://localhost/jesus_me_deu";
