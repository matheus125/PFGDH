...
//METODO PARA SALVAR SENHAS TITULADAS
    public void salvarSenhas() {
        String nome, idade, genero, deficiente, status_cliente;
        int id_frequencia;
        ...
        status_cliente = txtStatus_cliente.getText();
...
//                idade_dependente = txtidade2.getText();
    ...
    private void initComponents() {
        ...
        txtStatus_cliente = new javax.swing.JTextField();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtStatus_cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE))))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtStatus_cliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26))
    ...
    private void table_cliente_TitularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_cliente_TitularMouseClicked
        String nome = "" + table_cliente_Titular.getValueAt(table_cliente_Titular.getSelectedRow(), 0);
        con.getConectar();
        con.executarSql("select t.id, t.nome_Completo, t.cpf, t.idade_cliente, t.genero_cliente, t.status_cliente, s.deficiencia, d.nome_dependente, d.Idade, d.genero, d.dependencia_cliente from tb_titular t left join tb_dependentes d on d.id_titular = t.id left join tb_socio_economico_saude s on s.id_titular = t.id where t.nome_Completo ='" + nome + "'");
        DefaultTableModel modelo = (DefaultTableModel) table_cliente_Dependente.getModel();
        modelo.setNumRows(0);
        try {
            while (con.getResultSet().next()) {
                ...
                txtStatus_cliente.setText(con.getResultSet().getString("t.status_cliente"));
                deficiencia = txtdeficiencia.getText();
...
//                idade_dependente = txtidade2.getText();
    ...
    private javax.swing.JTextField txtStatus_cliente;
