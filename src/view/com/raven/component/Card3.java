...
public final class Card3 extends javax.swing.JPanel {

    int titular, dependente;
    ...
    private void initComponents() {
        ...
        btn_atualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/atualizar.png"))); // NOI18N
    ...
    public void TotalDependentes() {
        con.getConectar();
        con.executarSql("SELECT count(*) AS customerCount FROM tb_dependentes;");
        try {
            con.getResultSet().first();
            do {
                dependente = con.getResultSet().getInt("customerCount");
...
//            JOptionPane.showMessageDialog(null, "Erro na Consulta /nErro!" + e);
    ...
    public void TotalClientes() {
        con.getConectar();
        con.executarSql("SELECT count(*) AS customerCount from tb_titular");
        try {
            con.getResultSet().first();
            do {
                titular = con.getResultSet().getInt("customerCount");
...
//            JOptionPane.showMessageDialog(null, "Erro na Consulta /nErro!" + e);
    ...
    public void TotalGeral() {
        ...
        resultado = titular + dependente;
        lbValues.setText(String.valueOf(resultado));
    }
